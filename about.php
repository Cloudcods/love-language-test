...
<body>
    ...
    <div class="main1">
        ...
        <div class="body1">
            ...
            <h3>Notes</h3>
            <ul>
                <li>The Love Language Test is an informative tool designed to enhance your understanding of love languages. It does not replace professional advice or counseling.
                </li>

                <li>The results of the Love Language Test are meant to provide insights into your personal preferences and should be interpreted in the context of your unique experiences and relationships.
                </li>
            </ul>
        </div>
    </div>
    ...
    <footer class="main_foot">
        ...
        <div class="col2">
        Made with <span class="foot_s">  ♥</span> Devendra, Subinam & Suman Hacker
        </div>
        <div class="col3">
